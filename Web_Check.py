# -*- coding: utf-8 -*-
"""
Created on Sun Nov 28 19:34:07 2021
...
#checking time taken for each website
start_time = datetime.now()

url = input("Please enter the website name\n ")
# created a variable to store the status code

url_provided= str("https://")+url

status = check_url(url_provided)
